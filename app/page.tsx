...
const plans = [
  {
    name: 'Starter',
    price: 249,
    description: 'Para negocios que inician su digitalización.',
    features: [
      'Hasta 3 usuarios',
      'Hasta 500 productos',
  ...
  },
  {
    name: 'Pro',
    price: 499,
    description: 'El plan favorito de PyMEs en crecimiento.',
    features: [
      'Hasta 10 usuarios',
      'Productos ilimitados',
      'Todo en Starter',
      'Facturación CFDI 4.0',
      'Links de pago y WhatsApp',
      'Reportes avanzados',
      'Soporte prioritario',
    ],
  ...
  },
  {
    name: 'Enterprise',
    price: 999,
    description: 'Para operaciones grandes con varias sucursales.',
    features: [
      'Usuarios ilimitados',
      'Todo en Pro',
